...
var createTaskEl = function(taskDataObj) {
       ...
       var taskActionsEl = createTaskActions(taskIdCounter);
        ...
        // add task ID to the taskDataObj
...
var dropTaskHandler = function(event) {
    ...
    //remove style added to drop zone once dropped
...
var dragLeaveHandler = function () {
    ...
    if (taskListEl) {
        taskListEl.removeAttribute("style", "background: rgba(68, 233, 255, 0.7); border-style: dashed;")
        }
}
...
var loadTasks = function() {
    ...
    // if nothing returns from local storage, reassign tasks to new, empty tasks array
    if (!savedTasks) {
        return false;
    }

    //convert tasks back from the stringified format back into array of objects
